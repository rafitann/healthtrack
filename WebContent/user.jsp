    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
          <div
            class="d-flex profile justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom"
          >
            ...
            <div class="content-profile">
              ...
              <div>
                <div>
                  <p><span> Nome: </span> Rafaela</p>
                  <p><span> Sobrenome: </span> Narcizo</p>
                </div>
                <p><span> Email: </span> narcizo@gmail.com</p>
                <p><span> Idade: </span> 23</p>
                <p><span> Plano: </span> Gold</p>
