      ...
      <div class="row">
        ...
        >
          <div class="sidebar-sticky pt-3">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="food">
                  <svg
                    height="20"
                    viewBox="0 0 45 45"
                    fill="currentColor"
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
          ...
          <table class="table">
            ...
            <tbody>
              <tr>
                <th scope="row">Bolo de Cenoura</th>
                <td>1500 kcal</td>
                <td>Bolo com cobertura de chocolate</td>
              </tr>
              <tr>
                <th scope="row">Bolo de Limão</th>
                <td>1500 kcal</td>
                <td>Bolo com cobertura de Limão</td>
              </tr>
              <tr>
                <th scope="row">Bolo de Laranja</th>
                <td>1500 kcal</td>
                <td>Bolo com cobertura de Laranja</td>
              </tr>
            </tbody>
          </table>
        </main>
                ...
                <form class="needs-validation form-signin" novalidate>
                  ...
                  <div class="mb-2">
                    ...
                    <input
                      ...
                      required
                    />
                    <div class="invalid-feedback">Calories required</div>
                  </div>
                  <div class="mb-2">
