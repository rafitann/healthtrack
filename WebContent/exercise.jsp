...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Exercise · Health Track</title>
    <link
      rel="stylesheet"
        ...
        >
          <div class="sidebar-sticky pt-3">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="exercise">
                  <svg
                    height="20px"
                    viewBox="0 0 45 45"
                    fill="currentColor"
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Exercise</h5>
                <button
                  type="button"
                  class="close"
                  data-dismiss="modal"
              ...
              <div class="modal-body">
                <form class="needs-validation form-signin" novalidate>
                  <div class="mb-2">
                    <label for="input-height">Exercise</label>
                    <input
                      type="text"
                      class="form-control"
                      name="user"
                      ...
                      required
                    />
                    <div class="invalid-feedback">Exercise required</div>
                  </div>
                  <div class="mb-2">
                    <label for="input-weight">Time</label>
                    <input
                      type="text"
                      class="form-control"
                      name="user"
